...
|                <a name="input_emoji"></a>[emoji](#input_emoji)                | string |   true   |         | Emoji name to react with <br>(without colons). Common examples: white_check_mark ✅ <br>success / done x ❌ <br>failure rocket 🚀 deployment / <br>release eyes 👀 reviewing / <br>taking a look tada 🎉 <br>celebration warning ⚠️ warning hourglass_flowing_sand <br>⏳ in progress thumbsup 👍 <br>approval  |
