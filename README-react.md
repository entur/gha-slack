...
|-------|------|----------|---------|-------------|
| <a name="input_channel_id"></a>[channel_id](#input_channel_id) | string | true | | Slack channel id where the message was posted |
| <a name="input_emoji"></a>[emoji](#input_emoji) | string | true | | Emoji name to react with (without colons) |
| <a name="input_message_ts"></a>[message_ts](#input_message_ts) | string | true | | Slack message timestamp (unique message ID) to react to |
